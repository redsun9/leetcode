...
public class Solution {
    ...
    public static void main(String[] args) throws IOException {
        prepare();
        try (
                FileInputStream fis = new FileInputStream("src/advent/day23/first/input.txt");
                Scanner scanner = new Scanner(fis);
                FileOutputStream fos = new FileOutputStream("src/advent/day23/first/output.txt");
