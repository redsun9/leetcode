package advent.year2022.day14.second;
...
public class Solution {
    ...
    public static void main(String[] args) throws IOException {
        try (
                FileInputStream fis = new FileInputStream("src/advent/year2022/day14/second/input.txt");
                Scanner scanner = new Scanner(fis);
                FileOutputStream fos = new FileOutputStream("src/advent/year2022/day14/second/output.txt");
            ...
            maxX += 2;
            minY = Math.min(minY - 1, START_Y - maxX - 2);
            maxY = Math.max(maxY + 1, START_Y + maxX + 2);
            int width = maxY - minY;

            // 0 - unprocessed, 1 - stone, 2 - falling, 3 - rest
            int[][] status = new int[maxX + 1][width + 1];
            ...
            Arrays.fill(status[status.length - 1], 1);
