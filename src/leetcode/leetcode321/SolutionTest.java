...
class SolutionTest {
    ...
    void maxNumber() {
        ...
        assertArrayEquals(
                new int[]{9, 5, 7, 6, 5, 6, 2, 4, 3, 6, 2, 2, 2, 1, 3, 0, 2, 8, 9, 7, 7, 3, 2, 2, 9, 4, 5, 1},
                solution.maxNumber(
                        new int[]{9, 5, 6, 2, 4, 3, 6, 2},
                        new int[]{5, 7, 6, 2, 2, 1, 3, 0, 2, 8, 9, 7, 7, 3, 2, 2, 9, 4, 5, 1},
                        28
                )
        );
        assertArrayEquals(
                new int[]{7, 8, 4, 8, 9, 5, 4, 1, 2, 5, 8, 5, 7, 3, 7, 3, 0, 5, 8, 9, 5, 7, 3, 3, 4, 4, 0, 4, 0, 8, 2, 0},
                solution.maxNumber(
                        new int[]{4, 1, 2, 5, 8, 5, 7, 3, 7, 3, 0, 5, 8, 9, 5, 7, 3, 3, 4, 4, 0},
                        new int[]{7, 8, 4, 8, 9, 5, 0, 4, 0, 8, 2},
                        32
                )
        );
        assertArrayEquals(
                new int[]{9, 9, 9, 9, 9, 9, 9, 9, 7, 4, 1, 6, 3, 0, 4, 1, 4, 1, 8, 0, 3, 4, 4, 0, 3, 1, 2, 7, 9, 3, 2, 5, 5, 2, 7, 9, 5, 2, 2, 0, 2, 6, 7, 3, 0, 8, 8, 8, 6, 0, 1, 7, 8, 0, 2, 7, 5, 8, 7, 5, 2, 4, 0, 7, 3, 6, 3, 6, 3, 9, 6, 8, 1, 6, 9, 6, 2, 5, 9, 5, 1, 9, 2, 1, 4, 0, 7, 9, 8, 0, 4, 1, 0, 8, 7, 9, 7, 6, 6, 8, 8, 8, 3, 7, 5, 3, 2, 0, 4, 9, 1, 1, 3, 4, 9, 7, 9, 8, 4, 9, 6, 4, 7, 1, 9, 7, 4, 0, 4, 6, 0, 2, 0, 8, 9, 3, 0, 9, 9, 2},
                solution.maxNumber(
                        new int[]{3, 9, 9, 6, 9, 6, 2, 1, 1, 7, 7, 7, 1, 4, 9, 9, 6, 9, 5, 3, 6, 4, 6, 3, 8, 2, 5, 1, 1, 7, 9, 2, 3, 7, 4, 0, 3, 4, 4, 0, 2, 6, 7, 3, 0, 8, 8, 8, 6, 0, 1, 7, 8, 0, 2, 7, 5, 8, 7, 5, 2, 4, 0, 7, 3, 6, 3, 6, 3, 9, 6, 8, 1, 6, 9, 6, 2, 5, 9, 5, 1, 9, 2, 1, 4, 0, 7, 9, 8, 0, 4, 1, 0, 8, 7, 9, 7, 6, 6, 8, 8, 8, 3, 7, 5, 3, 2, 0, 4, 9, 1, 1, 3, 4, 9, 7, 9, 8, 4, 9, 6, 4, 7, 1, 9, 7, 4, 0, 4, 6, 0, 2, 0, 8, 9, 3, 0, 9, 9, 2},
                        new int[]{8, 8, 9, 1, 6, 3, 0, 4, 1, 4, 1, 8, 0, 3, 1, 2, 7, 9, 3, 2, 5, 5, 2, 7, 9, 5, 2, 2},
                        140
                )
        );
        assertArrayEquals(
                new int[]{9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 8, 8, 6, 8, 8, 4, 4, 5, 7, 5, 2, 8, 2, 7, 7, 7, 4, 8, 5, 0, 9, 6, 9, 2, 0, 2, 4, 2, 2, 1, 6, 6, 5, 3, 6, 2, 9, 6, 4, 5, 9, 7, 8, 0, 7, 2, 3},
                solution.maxNumber(
    ...
    void testPerf() {
        ...
        assertTrue(endTime - startTime < 1_000_000_000);
        startTime = System.nanoTime();
        solution.maxNumber(
                new int[]{1, 2, 0, 1, 0, 2, 2, 2, 0, 2, 1, 1, 1, 2, 2, 0, 0, 0, 2, 1, 2, 1, 2, 2, 0, 1, 2, 1, 0, 0, 0, 1, 0, 0, 1, 2, 1, 2, 1, 1, 0, 0, 2, 0, 1, 0, 0, 1, 2, 0, 1, 2, 0, 0, 2, 2, 1, 2, 1, 0, 0, 0, 0, 1, 0, 2, 0, 1, 2, 1, 1, 2, 1, 2, 1, 1, 2, 1, 2, 0, 2, 1, 2, 2, 0, 2, 0, 0, 0, 2, 0, 2, 0, 1, 2, 0, 1, 2, 2, 0},
                new int[]{1, 1, 0, 2, 1, 0, 0, 2, 2, 0, 0, 2, 1, 1, 1, 2, 2, 1, 1, 1, 1, 1, 1, 2, 2, 2, 1, 0, 1, 1, 0, 2, 0, 2, 1, 1, 1, 0, 2, 0, 2, 1, 1, 1, 2, 1, 1, 2, 0, 0, 1, 0, 0, 2, 2, 0, 0, 1, 0, 2, 1, 1, 1, 0, 2, 2, 0, 2, 0, 1, 0, 1, 1, 0, 1, 1, 2, 1, 1, 0, 2, 0, 0, 0, 1, 2, 1, 1, 1, 0, 1, 1, 1, 1, 2, 1, 2, 1, 2, 2},
                200
        );
