package leetcode.leetcode3xx.leetcode307;
...
public class NumArray {
    private final SegmentTree<Integer, Integer> tree;
    private final int n;
    ...
    public NumArray(int[] nums) {
        if (nums == null || nums.length == 0) {
            ...
            n = nums.length;
            tree = SegmentTree.sumSegmentTree(nums);
        }
    }
